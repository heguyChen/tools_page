    ...
    <div class="ge">
        <el-card class="card11">
            <div slot="header" class="clearfix">
                <span class="zi">{{ this.year + '年' + this.month + '月'
                    + this.jsonData[0].groupList[0].corpName }}上线过角色seat和QQ绑定详情</span>
                ...
                <el-button type="info" @click="getback" round class=" btn1">后退</el-button>
            </div>
...
.ge {
    ...
    .card11 {
        ...
        .zi {
            ...
            align-content: center;
            background: linear-gradient(to bottom, rgb(95, 94, 94), black);
